(function(f, l) {
    ...
    function Ja(a) {
        ...
        //q = new WebSocket("ws://127.0.0.1:1548");
		q = new WebSocket(a);
    ...
    function P(a) {
		...
		//console.log("[OUTCOMING][PACKET " + a.getUint8(0) + "][" + a.byteLength + "] " + Packet);
    }
	...
	var status = 0;
    function Ya(a) {
		var Data = new DataView(a.data);
		var PacketID = Data.getUint8(0);
		
		if(PacketID == 49) {
			var Packet = "";
			for (var i = 1; i < a.data.byteLength; i++) {
				Packet += Data.getUint8(i) + " - ";
			}
			console.log("[INCOMING][PACKET " + PacketID + "][" + a.data.byteLength + "] " + Packet);
			status++;
			//$a(Data)
		}
    ...
    function $a(a) {
        ...
        switch (a.getUint8(c++)) {
            case 16:
				//console.log("Packet 16");
                ab(a, c);
                break;
            case 17:
				//console.log("Packet 17");
				// Packet Spétacteur
				// Avec 4 byte d'aspace
                Q = a.getFloat32(c, !0);
                c += 4;
                R = a.getFloat32(c, !0);
                c += 4;
            ...
            case 21:
                ...
                break;
            case 32:
				//console.log("Packet 32");
				// Packet de spawn du joueur !
				// Taille de 4 byte
            ...
            case 49:
                ...
                break;
            case 50:
				//console.log("Packet 50");
				// Packet du leaderboard en Team !
				// Chaque float va de 0.0 = 0% à 1 = 100%
                y = [];
                d = a.getUint32(c, !0); // Nombre de team soit rouge, vert, blue
                c += 4;
